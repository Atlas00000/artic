...
export function GlobalStatsBar({ className }: GlobalStatsBarProps) {
  ...
  return (
    <div className={`w-full h-48 md:h-44 bg-gradient-to-b from-white/15 to-white/5 backdrop-blur-md border-b border-white/20 mt-16 ${className}`}>
      <div className="flex flex-col h-full px-4 md:px-8">
        {/* Enhanced Main Stats Row */}
        <div className="flex justify-between items-center h-24 md:h-22">
          <div className="flex space-x-4 md:space-x-8 lg:space-x-16 w-full justify-center md:justify-between">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center h-24 md:h-22 text-xs md:text-sm">
          {/* Enhanced Stats with Icons */}
          <div className="flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-8 lg:space-x-16 text-white/80 w-full md:w-auto">
            {/* Conservation Details */}
            <div className="flex items-center justify-center md:justify-start space-x-3 animate-fade-in" style={{ animationDelay: '0.5s' }}>
              <span className="text-emerald-300 text-lg">🌿</span>
              <div className="min-w-0">
                <div className="text-xs md:text-sm font-medium truncate">89 wildlife protected</div>
                <div className="text-xs text-emerald-300">+5 this week</div>
              </div>
            </div>
            
            {/* Community Stats */}
            <div className="flex items-center justify-center md:justify-start space-x-3 animate-fade-in" style={{ animationDelay: '0.7s' }}>
              <span className="text-blue-300 text-lg">👥</span>
              <div className="min-w-0">
                <div className="text-xs md:text-sm font-medium truncate">2,341 community members</div>
                <div className="text-xs text-blue-300">+23 today</div>
              </div>
            </div>
            
            {/* Learning Progress */}
            <div className="flex items-center justify-center md:justify-start space-x-3 animate-fade-in" style={{ animationDelay: '0.9s' }}>
              <span className="text-yellow-300 text-lg">📚</span>
              <div className="min-w-0">
                <div className="text-xs md:text-sm font-medium truncate">45 lessons completed</div>
